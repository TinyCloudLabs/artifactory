...
// video = the mp4 file name relative to the artifact dir.
//
// Usage:
...
// The mp4 lives beside artifact.json and publishes to TinyCloud media KV via
// tc-publish. The SQL feed row stores the resulting video_key/video_mime/
// video_sha256 pointer triple.
...
console.log(
  "NOTE: the mp4 is recorded in the typed `video` field and will publish to " +
    "TinyCloud media KV through tc-publish.",
);
