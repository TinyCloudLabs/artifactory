...
echo "  cp ops/launchd/feedrun.env.example ops/launchd/feedrun.env   # PATH + TRANSCRIPT_DIRS"
echo "  cp ops/launchd/server.env.example  ops/launchd/server.env    # PATH + OPENKEY_ALLOWED_ADDRESSES"
...
echo
echo "  # Logs: ops/launchd/logs/{feedrun,server,tunnel}.{out,err}.log"
echo "================================================================"
